...
def main():
    ...
    t1ce_file = st.file_uploader("Choose a T1CE NIfTI file", type=["nii"])
    t2_file = st.file_uploader("Choose a T2 NIfTI file", type=["nii"])
    flair_file = st.file_uploader("Choose a FLAIR NIfTI file", type=["nii"])
