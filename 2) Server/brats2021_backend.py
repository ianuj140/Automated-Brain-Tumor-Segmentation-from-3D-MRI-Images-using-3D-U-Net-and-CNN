...
st.set_page_config(page_title="Brats2021_WebPage", page_icon=":brain:", layout="wide")
...
def main():
    ...
    st.markdown(
        ...
        '>
            ...
            color:#FFFF00  ; font-size:32px; font-family:Verdana; text-align:center'>
    ...
    with col1:
        ...
        st.markdown(
            ...
            '>
                <p style='font-weight:bold; 
                color:#87CEEB  ;text-align:center ; font-size:33px; font-family:Verdana;'>Upload 3D MRI Scans of Patient below:            
                </p>
                <div style='margin-top:20px;'>
